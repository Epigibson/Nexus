...
const plans = [
  {
    ...
    description: "Para desarrolladores individuales que quieren eliminar el context switching.",
    features: [
      { text: "3 proyectos", icon: FolderKanban },
      { text: "Ambiente Development", icon: Terminal },
      { text: "5 skills básicos", icon: Sparkles },
      { text: "CLI completo", icon: Terminal },
      { text: "Git context switching", icon: Rocket },
      { text: "Env injection", icon: Zap },
    ],
    limits: [],
  },
  {
    ...
    color: "text-primary",
    popular: true,
    description: "Para devs profesionales que necesitan el catálogo completo de skills.",
    features: [
      { text: "10 proyectos", icon: FolderKanban },
      { text: "Todos los ambientes", icon: Terminal },
      { text: "12 skills completos", icon: Sparkles },
      { text: "Parallel Switch", icon: Zap },
      { text: "Script Runner", icon: Terminal },
      { text: "Auto Documentation", icon: BarChart3 },
      { text: "Cloud Audit Sync", icon: Users },
    ],
    limits: [],
  },
  {
    ...
    description: "Para equipos que necesitan gestión centralizada y compliance.",
    features: [
      { text: "Proyectos ilimitados (según necesidad del cliente)", icon: FolderKanban },
      { text: "Team Management", icon: Users },
      { text: "Audit trail centralizado", icon: BarChart3 },
      { text: "Roles: Owner, Admin, Dev", icon: ShieldCheck },
      { text: "SSO & Priority Support", icon: ShieldCheck },
      { text: "Custom Hooks", icon: Zap },
    ],
    limits: [],
  },
];
