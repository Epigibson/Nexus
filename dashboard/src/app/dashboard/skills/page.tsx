...
const CATEGORY_LABELS: Record<string, { label: string; color: string }> = {
  "git_state": { label: "Git", color: "text-orange-400 bg-orange-400/10 border-orange-400/20" },
  "cli_switching": { label: "CLI", color: "text-blue-400 bg-blue-400/10 border-blue-400/20" },
  "context_injection": { label: "Context", color: "text-emerald-400 bg-emerald-400/10 border-emerald-400/20" },
  ...
  "cloud_audit": { label: "Audit", color: "text-sky-400 bg-sky-400/10 border-sky-400/20" },
  "team_sync": { label: "Team", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  "secret_rotation": { label: "Secrets", color: "text-indigo-400 bg-indigo-400/10 border-indigo-400/20" },
  "container": { label: "Containers", color: "text-sky-400 bg-sky-400/10 border-sky-400/20" },
  "monitoring": { label: "Monitoring", color: "text-teal-400 bg-teal-400/10 border-teal-400/20" },
  "ci_cd": { label: "CI/CD", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
  "database": { label: "Database", color: "text-yellow-400 bg-yellow-400/10 border-yellow-400/20" },
  "notification": { label: "Notify", color: "text-red-400 bg-red-400/10 border-red-400/20" },
  "security": { label: "Security", color: "text-green-400 bg-green-400/10 border-green-400/20" },
};
